    ...
    */
    ...
    updateHandList(seatInfo: SeatVo, target) {
        ...
        if (dd.gm_manager.mjGameData.tableBaseVo.cfgId === MJ_Game_Type.GAME_TYPE_LSMJ
            ...
            isUnSuit = dd.gm_manager.getIsUnSuit(handCards, this._seatInfo.unSuit, 31);
        } else {
            isUnSuit = dd.gm_manager.getIsUnSuit(handCards, this._seatInfo.unSuit);
        }
    ...
    getTingsByCardId(cardIds: number[], cardId: number) {
        ...
        if (dd.gm_manager.mjGameData.tableBaseVo.cfgId === MJ_Game_Type.GAME_TYPE_LSMJ
            && dd.gm_manager.mjGameData.tableBaseVo.yaojiReplace === 1) {
            tings = dd.gm_manager.getTingPai(hands, this._seatInfo.unSuit, 31);
        } else {
            tings = dd.gm_manager.getTingPai(hands, this._seatInfo.unSuit);
        }
