...
declare interface SendRuleCfg {
    /**
     * 俱乐部id
     * 
     * @type {string}
     * @memberof SendRuleCfg
     */
    corpsId: string;
    /**
     * 游戏id
...
declare interface TableBaseVo {
    ...
    */
    ...
    ruleShowDesc: string;
    /**
     * 换牌方式(默认=0)(0=[0->3,3->2,2->1,1->0],1=[0->1,1->2,2->3,3->0],2=[0->2,1->3])
     * @memberof TableBaseVo
     */
    swapCardType: number;
    /**
...
declare interface welfareVo {
     ...
     * @memberof welfareVo
     */
    welfareList: TaskItemInner[];
    /**
     * 每日任务列表
     * @type {TaskItemInner[]}
     * @memberof welfareVo
     */
    dayTaskList: TaskItemInner[];
}
/**
 * 红包福利
 * @interface TaskItemInner
 */
declare interface TaskItemInner {
    /**
     * 任务Id
     * @type {number}
     * @memberof TaskItemInner
     */
    taskId: number;
    /**
     *任务完成状态(1=可领取,2=未完成,3=已领取)
     * @type {number}
     * @memberof TaskItemInner
     */
    state: number;
 ...
 */
declare interface RewardItems {
    /**
     * 物品Id
     * @type {number}
     * @memberof RewardItems
     */
    code: number;
    /**
     * 奖励类型
     ...
     *  10006	WALLET	体验房卡		
     *  10007	CHARGECARD	话费
     *  10008	REDPACKET	微信红包
     *  10009	REDPACKET	QQ红包		
     *  10010	REDPACKET	支付宝红包	
     *  10011	INSIDER	腾讯会员	
     *  10012	INSIDER	爱奇艺会员		
     *  10013	INSIDER	优酷会员
     * @type {string}
...
declare interface CoinVo {
    ...
    /**
     * 参与抽奖的奖励列表
     * @type {RewareSilverItem[]}
     * @memberof CoinVo
     */
    rewareList: RewareSilverItem[];
}
/**
 * 银币奖励信息
 * @interface RewareSilverItem
 */
declare interface RewareSilverItem {
    /**
     * 物品顺序号
     * @type {number}
     * @memberof RewareSilverItem
     */
    index: number;
    /**
     * 物品名称
...
/**
 * 金币奖品信息
 * @interface RewareGoldMoneyItem
 */
declare interface RewareGoldMoneyItem {
    /**
     * /物品Id
     * @type {number}
     * @memberof RewareGoldMoneyItem
     */
    itemId: number;
    /**
     *物品名称
...
/**
 * 商品详情
 * @interface RewareGoldItemInfo
 */
declare interface RewareGoldItemInfo {
    /**
     * 物品Id
     * @type {number}
     * @memberof RewareGoldItemInfo
     */
    itemId: number;
    /**
     * 物品名称
...
/**
 * 邮件信息
 * @interface MailVoItem
 */
declare interface MailVoItem {
    /**
     * 邮件Id
     * 
     * @type {number}
     ...
     * @memberof MailVoItem
     */
    attachmentGetState: number;
}
/**
 * 邮件内容
 * @interface MailView
 */
declare interface MailView {
    /**
     * 邮件Id
     * 
     * @type {number}
 ...
 */
declare interface MailAttachment {
    /**
     * 物体类型
     *  10000	ENTITY	实物
     *  10001	WALLET	充值房卡	
 ...
 * 搜索俱乐部返回数据
 * @export
 * @interface SearchClubVo
 */
declare interface SearchClubVo {
    //帮会Id
    corpsId: string;
    //帮会名称
    corpsName: string;
...
/**
 * 俱乐部房间 桌子数据改变
 * @interface ClubTableChange
 */
declare interface ClubTableChange {
    /**
     * 类型,1=增加,2=修改,3=删除
     * @type {number}
     * @memberof ClubTableChange
     */
    type: number;
    /**
     * 当前改变的桌子
     ...
     * @memberof ClubTableChange
     */
    table: CorpsTableItem;
}
/**
 * 俱乐部推送消息
 * @interface ClubPushMsg
 */
declare interface ClubPushMsg {
    //帮会Id
    corpsId: string;
    //帮会创建人
    createPlayer: string;
...
/**
 * 帮会微信公告修改通知
 * @interface ClubModifyMsg
 */
declare interface ClubModifyMsg {
    //帮会Id
    corpsId: string;
    //帮会公告
    corpsNotice: string;
...
/**
 * 俱乐部钱包变化push
 * @interface ClubWalletPush
 */
declare interface ClubWalletPush {
    /**
     *俱乐部Id
     * @type {string}
     * @memberof CorpsTable
    ...
    * 房卡数据
    * @type {string}
    * @memberof ClubTableMsg
    */
    roomCard: string;
}
/**
 * 俱乐部桌子消息
 * @interface ClubTableMsg
 */
declare interface ClubTableMsg {
    /**
     *俱乐部Id
     * @type {string}
     * @memberof CorpsTable
 ...
 * 俱乐部游戏桌子
 * 
 * @interface CorpsTable
 */
declare interface CorpsTable {
    /**
     *俱乐部Id
     * @type {string}
     * @memberof CorpsTable
     ...
     * @memberof CorpsTable
     */
    tables: CorpsTableItem[];
}

/**
 * 俱乐部每个桌子的信息
 * @interface CorpsTableItem
 */
declare interface CorpsTableItem {
    /**
    * 游戏名称
    * @type {string}
    * @memberof ClubTableMsg
 ...
 * 俱乐部成员信息
 * 
 * @interface CorpsMemberVoItem
 */
declare interface CorpsMemberVoItem {
    /**
     *呢称
     * @type {string}
     * @memberof CorpsMemberVoItem
     */
    nick: string;
    /**
     * 角色头像
...
/**
 * 帮会成员排行榜信息
 * @interface CorpsRankVoItem
 */
declare interface CorpsRankVoItem {
    /**
     *呢称
     * @type {string}
     * @memberof CorpsRankVoItem
     */
    nick: string;
    /**
     * 角色头像
