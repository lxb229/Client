...
public class AccountFacadeImp implements AccountFacade {
	...
	public Object account_login_phone(IoSession session, String phone, String code) {
		return accountService.account_login_phone(session, phone, code);
	}

	@Override
	public Object account_register(IoSession session, String phone, String code) {
		return accountService.account_register(session, phone, code);
	}

	@Override
	public Object account_get_sms_code(String phone) {
		return accountService.account_get_sms_code(phone);
	}

	@Override
	public Object account_customer_service() {
		return accountService.account_customer_service();
	}
