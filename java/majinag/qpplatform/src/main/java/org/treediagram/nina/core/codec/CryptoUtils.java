...
public class CryptoUtils {
	 ...
	 * AES加密
	 * */
	public static byte[] aes_encrypt(byte[] src, byte[] key) throws Exception{
	 ...
	 * AES解密
	 * */
	public static byte[] aes_decrypt(byte[] src, byte[] key) throws Exception{
		SecretKeySpec keySpec = new SecretKeySpec(key, "AES");
		//Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
		Cipher cipher = Cipher.getInstance("AES");
	...
	private final static String[] UPPERCASE = { "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "Q", "W", "E", "R",
	 ...
	 */
	@SuppressWarnings("unused")
	private final static String[] LOWERCASE = { "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "q", "w", "e", "r",
			"t", "y", "u", "i", "o", "p", "a", "s", "d", "f", "g", "h", "j", "k", "l", "z", "x", "c", "v", "b", "n",
			"m" };
