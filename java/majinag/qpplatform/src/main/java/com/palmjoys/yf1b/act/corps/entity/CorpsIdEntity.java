...
@Entity
@Memcached
public class CorpsIdEntity implements IEntity<Integer>, Lifecycle{
	@Id
	...
	public static CorpsIdEntity valueOf(int recordId){
		CorpsIdEntity retEntity = new CorpsIdEntity();
