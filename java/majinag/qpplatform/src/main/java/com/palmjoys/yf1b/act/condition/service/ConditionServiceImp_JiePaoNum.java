...
@Service
public class ConditionServiceImp_JiePaoNum implements ConditionService{
	@Autowired
	private TaskManager taskManager;
	@Override
	public int getConditionId() {
		return ConditionDefine.CONDITION_GAME_QINGYISHE;
	}
	...
	public ConditionCheckResult checkCondition(Long playerId, ConditionAttrib condition) {
		...
		ret.complete = taskStatisticsAttrib.dayJiePaoNum;		
		return ret;
	}
