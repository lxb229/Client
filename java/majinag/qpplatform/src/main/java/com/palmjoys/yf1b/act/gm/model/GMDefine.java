...
public class GMDefine {
	...
	//GM命令定义
	//GM公告命令
	public static final String GM_CMD_NOTICE = "/gm/notice"; 
	//GM帐号命令
	public static final String GM_CMD_ACCOUNT = "/gm/account";
	//GM程序后台管理命令
	public static final String GM_CMD_GMMANAGER = "/gm/gmManager";
	//GM帮会命令
	public static final String GM_CMD_CORPS = "/gm/corps";
