...
@Service
public class ConditionServiceImp_ChargeCardNum implements ConditionService{
	@Autowired
	private TaskManager taskManager;

	@Override
	public int getConditionId() {
		return ConditionDefine.CONDITION_CHARGE_CARDNUM;
	}
	...
	public ConditionCheckResult checkCondition(Long playerId, ConditionAttrib condition) {
		...
		ret.complete = taskStatisticsAttrib.dayChargeCard;		
		return ret;
	}
