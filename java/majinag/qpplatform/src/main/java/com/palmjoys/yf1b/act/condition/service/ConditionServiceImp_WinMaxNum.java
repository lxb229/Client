...
@Service
public class ConditionServiceImp_WinMaxNum implements ConditionService{
	@Autowired
	private TaskManager taskManager;
	
	@Override
	public int getConditionId() {
		return ConditionDefine.CONDITION_WINMAX_GAMENUM;
	}
	...
	public ConditionCheckResult checkCondition(Long playerId, ConditionAttrib condition) {
		...
		ret.complete = taskStatisticsAttrib.dayWinMaxNum;		
		return ret;
	}
