...
@Service
public class ConditionServiceImp_AGangCardNum implements ConditionService{
	@Autowired
	private TaskManager taskManager;
	
	@Override
	public int getConditionId() {
		return ConditionDefine.CONDITION_GAME_ANGANGCARD_NUM;
	}
	...
	public ConditionCheckResult checkCondition(Long playerId, ConditionAttrib condition) {
		...
		ret.complete = taskStatisticsAttrib.dayAnGangNum;		
		return ret;
	}
