...
@Service
public class ConditionServiceImp_ShareNum implements ConditionService{
	@Autowired
	private TaskManager taskManager;

	@Override
	public int getConditionId() {
		return ConditionDefine.CONDITION_GAME_SHARE_NUM;
	}
	...
	public ConditionCheckResult checkCondition(Long playerId, ConditionAttrib condition) {
		...
		ret.complete = taskStatisticsAttrib.daySharScoreNum;		
		return ret;
	}
