...
@Service
public class ConditionServiceImp_LuckRewareNum implements ConditionService{
	@Autowired
	private TaskManager taskManager;
	
	@Override
	public int getConditionId() {
		return ConditionDefine.CONDITION_SILVERLUCKREWARE_NUM;
	}
...
ConditionCheckResult ret = new ConditionCheckResult();
		...
		ret.complete = taskStatisticsAttrib.dayLuckRewardNum;		
		return ret;
	}
