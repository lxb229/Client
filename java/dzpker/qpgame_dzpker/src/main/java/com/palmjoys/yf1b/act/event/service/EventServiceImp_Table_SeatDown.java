...
import com.palmjoys.yf1b.act.event.model.EventData_Table_SeatDown;
...
@Service
public class EventServiceImp_Table_SeatDown implements EventService{
	@Static
	private Storage<Integer, EventConfig> eventCfgs;

	@Override
	public int getEventId() {
		return EventDefine.EVENT_TABLE_SEATDOWN;
	}
