...
import com.palmjoys.yf1b.act.event.model.EventData_Table_Win_Insurance;
...
@Service
public class EventServiceImp_Table_Win_Insurance implements EventService{
	@Static
	private Storage<Integer, EventConfig> eventCfgs;

	@Override
	public int getEventId() {
		return EventDefine.EVENT_TABLE_WIN_INSURANCE;
	}
	...
	public boolean execEvent(EventAttrib eventAttrib) {
		try{
			...
			EventData_Table_Win_Insurance msgVo = new EventData_Table_Win_Insurance();
			msgVo.playerId = (String)param1;
			msgVo.roomId = (Integer)param2;
			msgVo.houseOwner = (String)param3;
			msgVo.partyNo = (Integer)param4;
			msgVo.insuranceProfit = (Integer)param5;
			msgVo.profitTime = (Long)param6;
