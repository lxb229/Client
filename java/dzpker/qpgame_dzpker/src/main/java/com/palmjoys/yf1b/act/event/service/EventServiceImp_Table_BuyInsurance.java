...
import com.palmjoys.yf1b.act.event.model.EventData_Table_Buy_Insurance;
...
@Service
public class EventServiceImp_Table_BuyInsurance implements EventService{
	@Static
	private Storage<Integer, EventConfig> eventCfgs;

	@Override
	public int getEventId() {
		return EventDefine.EVENT_TABLE_BUY_INSURANCE;
	}
	...
	public boolean execEvent(EventAttrib eventAttrib) {
		try{
			...
			EventData_Table_Buy_Insurance msgVo = new EventData_Table_Buy_Insurance();
			msgVo.playerId = (String)param1;
			msgVo.roomId = (Integer)param2;
			msgVo.houseOwner = (String)param3;
			msgVo.partyNo = (Integer)param4;
			msgVo.insuranceNum = (Integer)param5;
			msgVo.insuranceTime = (Long)param6;
