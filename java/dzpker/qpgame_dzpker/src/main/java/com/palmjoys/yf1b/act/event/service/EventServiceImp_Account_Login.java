...
import com.palmjoys.yf1b.act.event.model.EventData_Account_Login;
...
@Service
public class EventServiceImp_Account_Login implements EventService{
	@Static
	private Storage<Integer, EventConfig> eventCfgs;

	@Override
	public int getEventId() {
		return EventDefine.EVENT_ACCOUNT_LOGIN;
	}
	...
	public boolean execEvent(EventAttrib eventAttrib) {
		try{
			...
			EventData_Account_Login msgVo = new EventData_Account_Login();
			msgVo.playerId = (String)param1;
			msgVo.loginType = (Integer)param2;
