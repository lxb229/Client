...
import com.palmjoys.yf1b.act.event.model.EventData_Table_Win_Cards;
...
@Service
public class EventServiceImp_Table_Win_Cards implements EventService{
	@Static
	private Storage<Integer, EventConfig> eventCfgs;

	@Override
	public int getEventId() {
		return EventDefine.EVENT_TABLE_WIN_CARDS;
	}
