    ...
    <div class="content">
        <form action="alipayapi.jsp" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDout_trade_no" value="<%=request.getParameter("out_trade_no")%>" id="out_trade_no"></div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDsubject" id="subject" value="<%=URLDecoder.decode(request.getParameter("subject"),"utf-8") %>"></div>
                <br>
                <div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>
            </div>
            <div class="element">
                <div class="etitle">付款金额:</div>
                <div class="einput"><input type="text" name="WIDtotal_fee" value="<%=request.getParameter("total_fee")%>"></div>
                <br>
                <div class="mark">注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</div>
            </div>
			<div class="element">
                <div class="etitle">商品描述:</div>
                <div class="einput"><input type="text" name="WIDbody" value="<%=URLDecoder.decode(request.getParameter("body"),"utf-8") %>"></div>
                <br>
