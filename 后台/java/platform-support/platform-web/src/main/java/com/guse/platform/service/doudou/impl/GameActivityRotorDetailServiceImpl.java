...
public class GameActivityRotorDetailServiceImpl extends BaseServiceImpl<GameActivityRotorDetail, java.lang.String> implements GameActivityRotorDetailService{
	...
	@Override
	public Result<PageResult<GameActivityRotorDetail>> queryLuckyWheelDetailPageList(GameActivityRotorDetail gameActivityRotorDetail, PageBean pageBean, Users user) {
		Long count = gameActivityRotorDetailMapper.countByParam(gameActivityRotorDetail, user);
		...
		List<GameActivityRotorDetail> list = gameActivityRotorDetailMapper.selectPageByParam(gameActivityRotorDetail,
				new PageResult<GameActivityRotorDetail>(pageBean.getPageNo(), pageBean.getPageSize(), count, "gard_prize_time"), user);
