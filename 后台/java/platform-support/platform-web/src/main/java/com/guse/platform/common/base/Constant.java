...
public class Constant {
	...
	public static Integer TASK_USER = 1;/**任务-用户信息数据*/
	public static Integer TASK_ROOMCARD = 2;/**任务-房卡信息数据*/
	public static Integer TASK_CLUB = 3;/**任务-俱乐部信息数据*/
	public static Integer TASK_CLUBUSER = 4;/**任务-俱乐部玩家信息数据*/
	public static Integer TASK_USERLUCK = 5;/**任务-玩家幸运值信息数据*/
