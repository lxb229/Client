...
/**
 * StatisticsEarningsVo
 * @author nbin
 * @date 2017年7月18日 下午2:04:29 
 * @version V1.0
 */
public class StatisticsEarningsVo implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		if(obj instanceof StatisticsEarningsVo == false) return false;
		if(this == obj) return true;
		StatisticsEarningsVo other = (StatisticsEarningsVo)obj;
