 ...
 * @version V1.0
 */
public class StatisticsUserVo implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		if(obj instanceof StatisticsUserVo == false) return false;
		if(this == obj) return true;
		StatisticsUserVo other = (StatisticsUserVo)obj;
