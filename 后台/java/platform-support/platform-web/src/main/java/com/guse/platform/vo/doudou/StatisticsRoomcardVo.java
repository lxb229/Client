...
/**
 * StatisticsRoomcardVo
 * @author nbin
 * @date 2017年7月18日 下午2:04:29 
 * @version V1.0
 */
public class StatisticsRoomcardVo implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		if(obj instanceof StatisticsRoomcardVo == false) return false;
		if(this == obj) return true;
		StatisticsRoomcardVo other = (StatisticsRoomcardVo)obj;
