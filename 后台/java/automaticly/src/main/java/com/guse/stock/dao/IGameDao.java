...
public interface IGameDao {
	...
	*/
	...
	public Game findByIdentify(@Param("identify")String identify);
	
	/** 
	* @Title: findById 
	* @Description: 根据游戏id查询 
	* @param @param id
	* @param @return
	* @return Game 
	* @throws 
	*/
	@Select("select * from pl_game where game_id=#{game_id}")
	public Game findById(@Param("game_id")long game_id);
