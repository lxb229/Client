...
<title>主页</title>
<script src="/static/easyui/plugins/jquery.form.js" type="text/javascript"></script>  
<script type="text/javascript">
    ...
    function welcome() {
    	...
    	opts.content = '<iframe src="https://www.baidu.com/" frameborder="0" style="border:0;width:100%;height:99.5%;"></iframe>';
        addTab(opts);
    }
    $(function() {
...
<body>
    ...
    <div id="index_layout">
        ...
        <div data-options="region:'center'" style="overflow: hidden;">
            <div id="index_tabs" style="overflow: hidden;">
                <div title="首页" data-options="iconCls:'fi-home',border:false" style="overflow: hidden;">
                    ...
                    <a href="javascript:void(0)" class="wechat-easyui-linkbutton-del" data-options="plain:true,iconCls:\'fi-x icon-red\'" onclick="welcome();" >欢迎登陆</a>
                </div>
            </div>
        </div>
        ...
        <!-- 
        Copyright © 2015 power by <a href="http://www.dreamlu.net/" target="_blank">如梦技术</a>
         -->
        </div>
    </div>
    <div id="tabsMenu">
