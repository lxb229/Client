 ...
 * 
 * @author nbin
 * @version $Id: ExcelUtils.java, v 0.1 2016年8月18日 上午11:53:10 nbin Exp $
 */
...
//                    	System.out.println(key+":"+map.get(key));
	...
	public static String dumpFont(HSSFFont font) {
		StringBuffer sb = new StringBuffer();
		sb.append(font.getItalic())
				.append(",")
				.append(font.getStrikeout())
				.append(",")
				.append(font.getBoldweight())
				.append(",")
				.append(font.getCharSet())
				.append(",")
