...
public class GameActivityRotorStatisticsServiceImpl extends BaseServiceImpl<GameActivityRotorStatistics, java.lang.Long> implements GameActivityRotorStatisticsService{
	...
	@Override
	public Result<PageResult<GameActivityRotorStatistics>> queryLuckyWheelPageList(PageBean pageBean) {
		// 今日实时统计数据
		...
		Long count = gameActivityRotorStatisticsMapper.countByParam(gameActivityRotorStatistics);
		...
		List<GameActivityRotorStatistics> list = gameActivityRotorStatisticsMapper.selectPageByParam(gameActivityRotorStatistics,
				new PageResult<GameActivityRotorStatistics>(pageBean.getPageNo(), pageBean.getPageSize(), count, "gars_date"));
