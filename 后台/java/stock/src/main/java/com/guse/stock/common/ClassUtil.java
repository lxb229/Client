...
public class ClassUtil {
	...
	public static void main(String[] args) {
        ...
        // 包下面的类
        Set<Class<?>> classes = getClasses("com.guse.stock.netty.handler.dispose.service");
        if (classes == null) {
            System.out.printf("null");
        } else {
            System.out.printf(classes.size() + "");
            // 某类或者接口的子类
            Set<Class<?>> inInterface = getByInterface(AbstractDispose.class, classes);
	...
	public static void getDisposes(Class clazz, String pack) {
		// 包下面的类
        Set<Class<?>> classesAll = getClasses("com.guse.stock.netty.handler.dispose.service");
                ...
                while (iterator.hasNext()) {
                    ...
                    if (clazz.isAssignableFrom(cls)) {
                        if (!clazz.equals(cls)) {//自身并不加进去
                            classes.add(cls);
                            AbstractDispose dispose = (AbstractDispose) cls.newInstance();
                            DISPOSE_CLASS_MAP.put(dispose.pt, (Class<? extends AbstractDispose>) cls);
                        } else {
